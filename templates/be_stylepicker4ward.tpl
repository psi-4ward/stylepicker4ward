...
<?php foreach($this->items as $item):?>
	...
	<div style="padding:5px 10px" class="clr">
		...
		<?php if(strlen($item['image'])):?><img src="<?php echo $this->getImage($item['image'],80,80,'proportional');?>" alt="" style="float:left;;cursor:pointer;" rel="<?php echo $item['image'];?>"/><?php endif;?>
